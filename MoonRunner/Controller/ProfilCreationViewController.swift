...
class ProfilCreationViewController: UIViewController {
  ...
  @IBAction func createProfil(_ sender: Any) {
    var castTailleProfil = String(self.tailleProfil.text ?? "1.5")
    var castPoidsProfil = String(self.poidsProfil.text ?? "60.0")
    var castAgeProfil = String(self.ageProfil.text ?? "18")
    var castNomProfil = String(self.nomProfil.text ?? "Merrien")
    var castPrenomProfil = String(self.prenomProfil.text ?? "Trystan")
    var castMailProfil = String(self.mailProfil.text ?? "trystanmerrien.fr")
    var castSexeProfil = "Autre"
    IDProfil += IDProfil + 1
    var castIDProfil = String(IDProfil)
    print(castIDProfil)
    print(IDProfil)
    // swiftlint:disable line_length
    AF.request("http://149.91.89.160:500/graphql?query=mutation%7B%0A%20%20createUtilisateur(%0A%20%20%20%20id%3A%20"+castIDProfil+"%2C%0A%20%20%20%20sexe%3A%20%22"+castSexeProfil+"%22%2C%0A%20%20%20%20taille%3A%20"+castTailleProfil+"%2C%0A%20%20%20%20nom%3A%20%22"+castNomProfil+"%22%2C%0A%20%20%20%20age%3A%20"+castAgeProfil+"%2C%0A%20%20%20%20prenom%3A%20%22"+castPrenomProfil+"%22%2C%0A%20%20%20%20email%3A%20%22"+castMailProfil+"%22%2C%0A%20%20%20%20poids%3A%20"+castPoidsProfil+"%0A%20%20)%0A%20%20%7B%0A%20%20%20%20%20%20id%2C%0A%20%20%20%20sexe%2C%0A%20%20%20%20taille%2C%0A%20%20%20%20nom%2C%0A%20%20%20%20age%2C%0A%20%20%20%20prenom%2C%0A%20%20%20%20email%2C%0A%20%20%20%20poids%0A%20%20%7D%0A%7D", method: .post, encoding: JSONEncoding.default)
